    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers(HttpMethod.DELETE, "/v1/pontoturistico/id/{id}").hasRole("ADM")
                                ...
                                .requestMatchers(HttpMethod.POST, "/v1/pontoturistico/{idPonto}/curitr/{idUsusario}").hasAnyRole("ADM", "PADRAO")
